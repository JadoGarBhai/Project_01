  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const docRef = await setDoc(
        doc(firestore, "accounts", state.id),
        accountData
      );
      ...
      console.log(docRef);
      toast.success(
        `Dear ${accountData.fullName} , your Account has been Created against Account # ${accountData.accountNumber}`,
        {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
          ...
          <div className="container">
            ...
            <form onSubmit={handleSubmit}>
              <div className="row mt-2 ">
                <div className="col-2 col-md-2 col-lg-1 icon">
                ...
                <div className="col-10 col-md-10 col-lg-5">
                  <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput">
                      CNIC Number (lenght should be 13)
                    </label>
                  </div>
                </div>
              </div>
              <div className="row ">
                ...
                <div className="col-10 col-md-10 col-lg-5">
                  <div class="form-floating mb-3">
                    ...
                    />
                    <label for="floatingInput">
                      Account Number(Length should be 9)
                    </label>
                  </div>
                </div>
              </div>
